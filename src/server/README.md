...
Node, one process, Fastify (see [ADR-0006](../../docs/decisions/0006-fastify-over-express.md)).
Domain modules under `modules/`, each owning its own tables and exposing a service
interface. Nothing reaches into another module's tables.
...
modules/
  ...
  billing/     W3  tax invoices, credit notes, payment collection (UPI, Razorpay, Cashfree)
